      ...
      <section className="about">
        <div className="row">
          ...
          <div className="content">
            <h3>why chosse us</h3>
            <p>
            Our placement platform offers a range of benefits to both candidates and recruiters.
             For companies, we provide a streamlined hiring process that saves time and resources ⏱️. 
             Our platform enables access to a wider pool of qualified candidates, including passive job seekers, increasing the chances of finding the perfect fit for the job 🎯.
             Additionally, our cost-effective solutions help reduce the overall cost per hire 💰.
            </p>
